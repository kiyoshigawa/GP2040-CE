...
#define BOARD_LEDS_PIN 25

#define LED_BRIGHTNESS_MAXIMUM 10
...
#define LEDS_DPAD_UP     9
#define LEDS_DPAD_LEFT   10
#define LEDS_DPAD_DOWN   11
#define LEDS_DPAD_RIGHT  12
#define LEDS_BUTTON_S1   13
